    ...
    try {
      ...
      if (args.receiverId === args.senderId) {
        throw new GraphQLError(
          "You can't send a transaction in the same account",
          {
      ...
      if (!sender) {
        throw new GraphQLError("Not found the sender account", {
      ...
      if (!receiver) {
        throw new GraphQLError("Not found the receiver account", {
          extensions: { code: "NOT_FOUND" },
        });
      }
